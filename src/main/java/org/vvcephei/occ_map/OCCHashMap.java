 ...
 * operations.  {@link OCCHashMap} scales substantially better than
 ...
 *
 * @author John Roesler - Copied from https://github.com/boundary/high-scale-lib @ 3654434eda00b68d37d22dcd70e4f65db9432d06
 * and modified for OCC semantics.
 */

public class OCCHashMap<TypeK, TypeV extends Versioned>
  ...
  static {                      // <clinit>
    Field f = null;
    try { f = OCCHashMap.class.getDeclaredField("_kvs"); }
  ...
  /** Create a new OCCHashMap with default minimum size (currently set
   *  to 8 K/V pairs or roughly 84 bytes on a standard 32-bit JVM). */
  public OCCHashMap( ) { this(MIN_SIZE); }

  /** Create a new OCCHashMap with initial room for the given number of
  ...
  public OCCHashMap( final int initial_sz ) { initialize(initial_sz); }
  ...
  public void clear() {         // Smack a new empty table down
    Object[] newkvs = new OCCHashMap(MIN_SIZE)._kvs;
  ...
  public Object clone() {
    try {
      ...
      OCCHashMap<TypeK,TypeV> t = (OCCHashMap<TypeK,TypeV>) super.clone();
  ...
  private static final Object get_impl( final OCCHashMap topmap, final Object[] kvs, final Object key, final int fullhash ) {
  ...
  private static final Object putIfMatch( final OCCHashMap topmap, final Object[] kvs, final Object key, final Object putval, final Object expVal ) {
    assert putval != null;
  ...
  // --- CHM -----------------------------------------------------------------
  // The control structure for the OCCHashMap
  private static final class CHM<TypeK,TypeV> {
    ...
    private final Object[] resize( OCCHashMap topmap, Object[] kvs) {
      assert chm(kvs) == this;
    ...
    // of the top position.
    private final void help_copy_impl( OCCHashMap topmap, Object[] oldkvs, boolean copy_all ) {
    ...
    // read it yet.
    private final Object[] copy_slot_and_check( OCCHashMap topmap, Object[] oldkvs, int idx, Object should_help ) {
      assert chm(oldkvs) == this;
      Object[] newkvs = _newkvs; // VOLATILE READ
    ...
    private final void copy_check_and_promote( OCCHashMap topmap, Object[] oldkvs, int workdone ) {
      assert chm(oldkvs) == this;
    ...
    private boolean copy_slot( OCCHashMap topmap, int idx, Object[] oldkvs, Object[] newkvs ) {
  ...
  private class SnapshotV implements Iterator<TypeV>, Enumeration<TypeV> {
    ...
    public SnapshotV() {
      while( true ) {           // Verify no table-copy-in-progress
        ...
        topchm.help_copy_impl(OCCHashMap.this,topkvs,true);
      }
      // Warm-up the iterator
      next();
    }
    int length() { return len(_sskvs); }
    Object key(int idx) { return OCCHashMap.key(_sskvs,idx); }
    ...
    public void remove() {
      ...
      putIfMatch( OCCHashMap.this, _sskvs, _prevK, TOMBSTONE, _prevV );
      _prevV = null;
    }
  ...
  public Collection<TypeV> values() {
    return new AbstractCollection<TypeV>() {
      @Override public void    clear   (          ) {        OCCHashMap.this.clear        ( ); }
      @Override public int     size    (          ) { return OCCHashMap.this.size         ( ); }
      @Override public boolean contains( Object v ) { return OCCHashMap.this.containsValue(v); }
  ...
  public Set<TypeK> keySet() {
    return new AbstractSet<TypeK> () {
      @Override public void    clear   (          ) {        OCCHashMap.this.clear   ( ); }
      @Override public int     size    (          ) { return OCCHashMap.this.size    ( ); }
      @Override public boolean contains( Object k ) { return OCCHashMap.this.containsKey(k); }
      @Override public boolean remove  ( Object k ) { return OCCHashMap.this.remove  (k) != null; }
   ...
   *  iteration.  The {@link OCCHashMap} does not normally create or
  ...
  public Set<Map.Entry<TypeK,TypeV>> entrySet() {
    return new AbstractSet<Map.Entry<TypeK,TypeV>>() {
      ...
      @Override public boolean remove( final Object o ) {
        ...
        return OCCHashMap.this.remove(e.getKey(), e.getValue());
      }
